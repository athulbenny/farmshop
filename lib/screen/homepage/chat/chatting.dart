...
class Chatting extends StatefulWidget {
  const Chatting({required this.CustomerEmail,required this.Farmeremail});
...
class _ChattingState extends State<Chatting> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider.value(
      initialData: null,
      value: Channel(cmail: widget.CustomerEmail,fmail: widget.Farmeremail).users,
        ...
        children: [
          Container(
            ...
            child: ListView.builder(
              ...
              if(listofmsgs[index].sender==widget.CustomerEmail){
                return Padding(
